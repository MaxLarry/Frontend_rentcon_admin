...
function PropertyListedCount() {
  ...
  return (
    <Card className="rounded-md shadow-md block items-center col-start-1 col-end-5 noselect h-96">
      <CardHeader className="items-center pb-0">
        <CardTitle className="text-sm font-bold">Listed Property</CardTitle>
        <CardDescription className="text-xs">
          Current Total of Listed Properties
        </CardDescription>
      </CardHeader>
