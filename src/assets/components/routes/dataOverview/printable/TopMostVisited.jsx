...
function TopMostVisited() {
  ...
  return (
    <div className=" shadow-md block items-center col-start-1 col-end-10 noselect">
      <div className="text-xl font-bold">Top 3 Most Visited Properties</div>
      <div className="grid pt-2 gap-6 grid-cols-3 grid-rows-subgrid max-w-full mx-auto">
