...
function ActiveuserHistogram() {
  ...
  return (
    <Card className="rounded-md shadow-md block items-center col-start-1 col-end-10 noselect h-80">
      <CardHeader className="flex flex-row justify-between pb-6">
        <div>
          <CardTitle className="text-sm font-bold">Active User</CardTitle>
